      ...
      >
        ...
        <div className='min-h-[calc(92vh-2rem)] w-full flex justify-center'>
          <div className='flex justify-center w-full flex-col items-center space-y-2 my-4 '>
            {!selectedFile ? (
              <div className='relative 2xl:w-36 mb-3 2xl:h-36 w-28 h-28 overflow-hidden bg-gray-600 rounded-full'>
                <Avatar
                  width='26'
                  height='26'
              ...
              <img
                className='w-28 h-28 rounded-full object-cover p-1 mb-3'
                src={selectedFile || ''}
                alt='Logo image'
              />
            )}
            ...
            <p className='text-gray-600 text-center text-sm w-1/2 py-5 md:w-1/4'>
