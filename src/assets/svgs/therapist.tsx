const Therapist = ({ width = '24', height = '24' }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <rect width='24' height='24' rx='8' fill='#6F00FF' fillOpacity='0.75' />
      <rect
        width='24'
        height='24'
        rx='8'
        fill='url(#paint0_radial_2441_8687)'
        fillOpacity='0.4'
      />
      <rect
        width='24'
        height='24'
        rx='8'
        fill='url(#paint1_radial_2441_8687)'
      />
      <rect width='24' height='24' rx='8' fill='#CDCDCD' fillOpacity='0.24' />
      <defs>
        <radialGradient
          id='paint0_radial_2441_8687'
          cx='0'
          cy='0'
          r='1'
        ...
        >
          <stop stopColor='#9747FF' stopOpacity='0.18' />
          <stop offset='0.74033' stopColor='#9747FF' stopOpacity='0' />
        </radialGradient>
      </defs>
    </svg>
  );
