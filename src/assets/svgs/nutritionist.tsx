const Nutritionist = ({ width = '24', height = '24' }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <rect width='24' height='24' rx='8' fill='#00FF40' fillOpacity='0.75' />
      <rect
        width='24'
        height='24'
        rx='8'
        fill='url(#paint0_radial_2441_8666)'
        fillOpacity='0.4'
      />
      <rect
        width='24'
        height='24'
        rx='8'
        fill='url(#paint1_radial_2441_8666)'
      />
      <rect width='24' height='24' rx='8' fill='#CDCDCD' fillOpacity='0.24' />
      <defs>
        <radialGradient
          id='paint0_radial_2441_8666'
          cx='0'
          cy='0'
          r='1'
        ...
        >
          <stop stopColor='#00FF40' stopOpacity='0.1' />
          <stop offset='0.74033' stopColor='#00FF40' stopOpacity='0' />
        </radialGradient>
      </defs>
    </svg>
  );
